  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      <button
        onClick={togglePlay}
        disabled={isLoading}
        className="transition-all duration-300 cursor-pointer text-text hover:text-primary disabled:opacity-50 p-1.5 rounded-lg hover:bg-primary/10"
      ...
      <div className="flex-1 flex items-center gap-2">
        ...
        <input
          ...
          className={`flex-1 h-1 rounded-lg appearance-none cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary/10 transition-all ${progressPercent >= 99.5 ? "[&::-webkit-slider-thumb]:translate-x-0.5 [&::-moz-range-thumb]:translate-x-0.5" : ""}`}
          style={{
            background: `linear-gradient(to right, var(--color-primary) 0%, var(--color-primary) ${progressPercent}%, rgba(128, 128, 128, 0.1) ${progressPercent}%, rgba(128, 128, 128, 0.1) 100%)`,
          }}
        />
