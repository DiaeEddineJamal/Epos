    ...
    >
      <div className="space-y-3">
        ...
        {!isCreating && hasPrompts && selectedPrompt && (
          <div className="space-y-3">
            <div className="space-y-2 flex flex-col">
              <label className="text-[13px] font-bold text-mid-gray/70 uppercase tracking-widest">
        ...
        {!isCreating && !selectedPrompt && (
          <div className="p-4 bg-background-ui rounded-xl border border-primary/10 text-center shadow-sm">
            <p className="text-sm text-text/70 font-medium italic">
              {hasPrompts
